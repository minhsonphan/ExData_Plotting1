...
# Plot 1
with(dt1,plot(x=Date_Time, y=Global_active_power, type="l", xlab="", ylab="Global Active Power"))

# Plot 2
with(dt1,plot(x=Date_Time, y=Voltage, type="l", xlab="datetime", ylab="Voltage"))
...
# Plot 4
with(dt1,plot(x=Date_Time, y=Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
